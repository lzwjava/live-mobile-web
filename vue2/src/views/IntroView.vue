...
export default {
  ...
  methods: {
    ...
    intoLive () {
      this.$router.push(`/live/${this.liveId}`)
    },
    payOrCreateAttend () {
      if (this.live.needPay) {
        this.pay()
    ...
    goUsers () {
      this.$router.push(`/live/${this.liveId}/users`)
    },
    seeLives () {
    ...
    goInvite () {
      this.$router.push(`/live/${this.liveId}/invites`)
    },
    goUserRoom (userId) {
      this.$router.push(`/room/${userId}`)
    },
    editLive () {
      this.$router.push(`/editLive/${this.liveId}`)
    },
    clickCover () {
      this.attendLive()
    }
